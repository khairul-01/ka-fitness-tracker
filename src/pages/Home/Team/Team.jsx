            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="card bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className=""><GiSkills className="inline" /> <span className="font-bold">Qualifications:</span> Certified Personal Trainer (CPT), Nutrition Specialist</div>
                        <div className=""><GrUserExpert className="inline" /><span className="font-bold">Expertise:</span> High-Intensity Interval Training (HIIT), Nutrition Coaching</div>

                        <p ><FcAbout className="inline" /> <span className="font-bold">About: </span> Jessica is passionate about helping individuals achieve their fitness goals through dynamic and effective workouts. With a focus on HIIT, she believes in the power of short, intense bursts of exercise to maximize results. Her nutrition expertise complements her training programs, ensuring a holistic approach to health and wellness.</p>
